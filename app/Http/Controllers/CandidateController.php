...
class CandidateController extends Controller
{
    ...
    public function edit(candidate $candidate)
    {
        ...
        return view('admin.candidate.edit', compact('fileTypes', 'client_files', 'candidate', 'outlet_data', 'religion_data', 'passtype_data', 'marital_data', 'race_data', 'department_data', 'designation_data', 'paymode_data', 'remarks_type', 'client_remarks', 'job_types', 'clients', 'payrolls'));
    }
    ...
    public function payroll(PayrollRequest $request, $id)
    {
        ...
        return redirect()->route('candidate.edit', $id)->with('success','Payroll added successfully.');
    }
