            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu collapse mm-collapse" aria-expanded="false">
                        ...
                        @if ($usr->can('client-term.index'))
                            <li><a href="{{route('client-term.index')}}" data-key="client-terms">Client Terms</a></li>
                        @endif
                ...
                <li>
                    ...
                    <ul class="sub-menu collapse mm-collapse" aria-expanded="false">
                        ...
                        <li><a href="{{route('marital-status.index')}}" data-key="marital-status">Marital Status</a></li>
                        @endif
                        @if ($usr->can('designation.index'))
                        <li><a href="{{route('designation.index')}}" data-key="designation">Designation</a></li>
                        @endif
                ...
                <li>
                    ...
                    <ul class="sub-menu collapse mm-collapse" aria-expanded="false">
                        ...
                        <li><a href="{{route('job-application.index')}}" data-key="job-applications">Job Applications</a>
                        @endif
                        </li>
                    </ul>
                </li>
