                                            ...
                                            <select name="employees_id" class="form-control">
                                                ...
                                                @foreach ($employees as $employee)
                                                    <option value="{{ $employee->id }}"
                                                        {{ $leave->employees_id == $employee->id ? 'selected' : '' }}>
                                            ...
                                            <select name="leave_types_id" class="form-control">
                                                ...
                                                @foreach ($leaveType as $type)
                                                    <option value="{{ $type->id }}"
                                                        {{ $leave->leave_types_id == $type->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-sm-9">
                                            <select name="leave_duration" class="form-control">
                                                <option value="Full Day Leave"
                                                    {{ $leave->leave_duration == 'Full Day Leave' ? 'selected' : '' }}>Full
                                                    Day Leave</option>
                                                <option value="Half Day AM"
                                                    {{ $leave->leave_duration == 'Half Day AM' ? 'selected' : '' }}>Half
                                                    Day
                                                    AM</option>
                                                <option value="Half Day PM"
                                                    {{ $leave->leave_duration == 'Full Day PM' ? 'selected' : '' }}>Half
                                                    Day
                                                    PM</option>
                                            </select>
                                        </div>
