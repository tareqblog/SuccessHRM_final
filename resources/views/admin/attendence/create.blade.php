                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content p-3 text-muted">
                            <div class="tab-pane active" id="General" role="tabpanel">
                                <form action="{{ route('get.month.attendence.data') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="row col-lg-6 mb-4">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="date" name="date" id="dateInput" class="form-control"
                                                    value="{{ isset($selectedDate) ? $selectedDate : '' }}">
                                            </div>
                                        </div>
                                        <div>
                                        ...
                                        <form action="#" method="POST">
                                            ...
                                            <div class="form-group" style="max-width: 100%;overflow: auto;">
                                                <div style="display:flex">
                                                    ...
                                                    <label class="control-label"
                                                        style="flex:0 0 120px;text-align:center;">Time
                                                        In</label>
                                                    <label class="control-label"
                                                        style="flex:0 0 120px;text-align:center;">Time
                                                        Out</label>
                                                    <label class="control-label"
                                                        style="flex:0 0 50px;text-align:center;">Next
                                                        Day</label>
                                                    <label class="control-label"
                                                        style="flex:0 0 120px;text-align:center;">Lunch
                                                        Hour</label>
                                                    <label class="control-label"
                                                        style="flex:0 0 120px;text-align:center;">Total
                                                        Hour /
                                                        Minute</label>
                                                    <label class="control-label"
                                                        ...
                                                        Minute</label>
                                                    <label class="control-label"
                                                        style="flex:0 0 120px;text-align:center;">OT
                                                        Hour / Minute</label>
                                                    <label class="control-label"
                                                        style="flex:0 0 120px;text-align:center;">OT
                                                        Calculation</label>
                                                    ...
                                                    <label class="control-label"
                                                        style="flex:0 0 100px;text-align:center;"><input type="checkbox"
                                                            name="work_checkbox" class="work_checkbox_parent">
                                                        Work</label>
                                                    <label class="control-label"
                                                        style="flex:0 0 50px;text-align:center;">PH</label>
                                                    <label class="control-label"
                                                        style="flex:0 0 50px;text-align:center;">PH
                                                        Pay</label>
                                                    <label class="control-label"
