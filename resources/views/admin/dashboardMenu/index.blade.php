                                    ...
                                    <form action="{{ route('menu.store') }}" method="POST">
                                        ...
                                        <label for="menu_group">Menu icon</label>
                                            ...
                                            <option value='fa fa-500px'>&#xf26e; fa-500px</option>
                                                ...
                                                <option value='fa fa-address-card'>&#xf2bb; fa-address-card</option>
                                                <option value='fa fa-address-card-o'>&#xf2bc; fa-address-card-o</option>
                                                ...
                                                <option value='fa fa-american-sign-language-interpreting'>&#xf2a3; fa-american-sign-language-interpreting</option>
                                                ...
                                                <option value='fa fa-asl-interpreting'>&#xf2a3; fa-asl-interpreting</option>
                                                <option value='fa fa-assistive-listening-systems'>&#xf2a2; fa-assistive-listening-systems</option>
                                                <option value='fa fa-asterisk'>&#xf069; fa-asterisk</option>
                                                <option value='fa fa-at'>&#xf1fa; fa-at</option>
                                                <option value='fa fa-audio-description'>&#xf29e; fa-audio-description</option>
                                                ...
                                                <option value='fa fa-bandcamp'>&#xf2d5; fa-bandcamp</option>
                                                ...
                                                <option value='fa fa-bath'>&#xf2cd; fa-bath</option>
                                                <option value='fa fa-bathtub'>&#xf2cd; fa-bathtub</option>
                                                ...
                                                <option value='fa fa-blind'>&#xf29d; fa-blind</option>
                                                <option value='fa fa-bluetooth'>&#xf293; fa-bluetooth</option>
                                                <option value='fa fa-bluetooth-b'>&#xf294; fa-bluetooth-b</option>
                                                ...
                                                <option value='fa fa-chevron-circle-right'>&#xf138; fa-chevron-circle-right</option>
                                                ...
                                                <option value='fa fa-codiepie'>&#xf284; fa-codiepie</option>
                                                ...
                                                <option value='fa fa-credit-card-alt'>&#xf283; fa-credit-card-alt</option>
                                                ...
                                                <option value='fa fa-deaf'>&#xf2a4; fa-deaf</option>
                                                <option value='fa fa-deafness'>&#xf2a4; fa-deafness</option>
                                                ...
                                                <option value='fa fa-drivers-license'>&#xf2c2; fa-drivers-license</option>
                                                <option value='fa fa-drivers-license-o'>&#xf2c3; fa-drivers-license-o</option>
                                                <option value='fa fa-dropbox'>&#xf16b; fa-dropbox</option>
                                                <option value='fa fa-drupal'>&#xf1a9; fa-drupal</option>
                                                <option value='fa fa-edge'>&#xf282; fa-edge</option>
                                                <option value='fa fa-edit'>&#xf044; fa-edit</option>
                                                <option value='fa fa-eercast'>&#xf2da; fa-eercast</option>
                                                ...
                                                <option value='fa fa-envelope-open-o'>&#xf2b7; fa-envelope-open-o</option>
                                                <option value='fa fa-envelope-square'>&#xf199; fa-envelope-square</option>
                                                <option value='fa fa-envira'>&#xf299; fa-envira</option>
                                                <option value='fa fa-eraser'>&#xf12d; fa-eraser</option>
                                                <option value='fa fa-etsy'>&#xf2d7; fa-etsy</option>
                                                ...
                                                <option value='fa fa-fa'>&#xf2b4; fa-fa</option>
                                                ...
                                                <option value='fa fa-first-order'>&#xf2b0; fa-first-order</option>
                                                ...
                                                <option value='fa fa-font-awesome'>&#xf2b4; fa-font-awesome</option>
                                                <option value='fa fa-fonticons'>&#xf280; fa-fonticons</option>
                                                <option value='fa fa-fort-awesome'>&#xf286; fa-fort-awesome</option>
                                                ...
                                                <option value='fa fa-free-code-camp'>&#xf2c5; fa-free-code-camp</option>
                                                ...
                                                <option value='fa fa-gitlab'>&#xf296; fa-gitlab</option>
                                                <option value='fa fa-gittip'>&#xf184; fa-gittip</option>
                                                <option value='fa fa-glass'>&#xf000; fa-glass</option>
                                                <option value='fa fa-glide'>&#xf2a5; fa-glide</option>
                                                ...
                                                <option value='fa fa-google-plus-circle'>&#xf2b3; fa-google-plus-circle</option>
                                                <option value='fa fa-google-plus-official'>&#xf2b3; fa-google-plus-official</option>
                                                ...
                                                <option value='fa fa-grav'>&#xf2d6; fa-grav</option>
                                                ...
                                                <option value='fa fa-hard-of-hearing'>&#xf2a4; fa-hard-of-hearing</option>
                                                <option value='fa fa-hashtag'>&#xf292; fa-hashtag</option>
                                                ...
                                                <option value='fa fa-id-card-o'>&#xf2c3; fa-id-card-o</option>
                                                <option value='fa fa-ils'>&#xf20b; fa-ils</option>
                                                <option value='fa fa-image'>&#xf03e; fa-image</option>
                                                <option value='fa fa-imdb'>&#xf2d8; fa-imdb</option>
                                                ...
                                                <option value='fa fa-linode'>&#xf2b8; fa-linode</option>
                                                ...
                                                <option value='fa fa-low-vision'>&#xf2a8; fa-low-vision</option>
                                                ...
                                                <option value='fa fa-meetup'>&#xf2e0; fa-meetup</option>
                                                <option value='fa fa-meh-o'>&#xf11a; fa-meh-o</option>
                                                <option value='fa fa-mercury'>&#xf223; fa-mercury</option>
                                                <option value='fa fa-microchip'>&#xf2db; fa-microchip</option>
                                                ...
                                                <option value='fa fa-pause-circle-o'>&#xf28c; fa-pause-circle-o</option>
                                                ...
                                                <option value='fa fa-pied-piper-pp'>&#xf1a7; fa-pied-piper-pp</option>
                                                ...
                                                <option value='fa fa-podcast'>&#xf2ce; fa-podcast</option>
                                                <option value='fa fa-power-off'>&#xf011; fa-power-off</option>
                                                <option value='fa fa-print'>&#xf02f; fa-print</option>
                                                <option value='fa fa-product-hunt'>&#xf288; fa-product-hunt</option>
                                                ...
                                                <option value='fa fa-question-circle-o'>&#xf29c; fa-question-circle-o</option>
                                                <option value='fa fa-quora'>&#xf2c4; fa-quora</option>
                                                ...
                                                <option value='fa fa-ravelry'>&#xf2d9; fa-ravelry</option>
                                                ...
                                                <option value='fa fa-reddit-alien'>&#xf281; fa-reddit-alien</option>
                                                ...
                                                <option value='fa fa-s15'>&#xf2cd; fa-s15</option>
                                                ...
                                                <option value='fa fa-scribd'>&#xf28a; fa-scribd</option>
                                                ...
                                                <option value='fa fa-shopping-bag'>&#xf290; fa-shopping-bag</option>
                                                <option value='fa fa-shopping-basket'>&#xf291; fa-shopping-basket</option>
                                                <option value='fa fa-shopping-cart'>&#xf07a; fa-shopping-cart</option>
                                                <option value='fa fa-shower'>&#xf2cc; fa-shower</option>
                                                <option value='fa fa-sign-in'>&#xf090; fa-sign-in</option>
                                                <option value='fa fa-sign-language'>&#xf2a7; fa-sign-language</option>
                                                <option value='fa fa-sign-out'>&#xf08b; fa-sign-out</option>
                                                <option value='fa fa-signal'>&#xf012; fa-signal</option>
                                                <option value='fa fa-signing'>&#xf2a7; fa-signing</option>
                                                ...
                                                <option value='fa fa-snapchat'>&#xf2ab; fa-snapchat</option>
                                                ...
                                                <option value='fa fa-stop-circle-o'>&#xf28e; fa-stop-circle-o</option>
                                                ...
                                                <option value='fa fa-stumbleupon-circle'>&#xf1a3; fa-stumbleupon-circle</option>
                                                <option value='fa fa-subscript'>&#xf12c; fa-subscript</option>
                                                <option value='fa fa-subway'>&#xf239; fa-subway</option>
                                                <option value='fa fa-suitcase'>&#xf0f2; fa-suitcase</option>
                                                <option value='fa fa-sun-o'>&#xf185; fa-sun-o</option>
                                                <option value='fa fa-superpowers'>&#xf2dd; fa-superpowers</option>
                                                ...
                                                <option value='fa fa-telegram'>&#xf2c6; fa-telegram</option>
                                                <option value='fa fa-television'>&#xf26c; fa-television</option>
                                                ...
                                                <option value='fa fa-themeisle'>&#xf2b2; fa-themeisle</option>
                                                <option value='fa fa-thermometer'>&#xf2c7; fa-thermometer</option>
                                                <option value='fa fa-thermometer-0'>&#xf2cb; fa-thermometer-0</option>
                                                <option value='fa fa-thermometer-1'>&#xf2ca; fa-thermometer-1</option>
                                                <option value='fa fa-thermometer-2'>&#xf2c9; fa-thermometer-2</option>
                                                <option value='fa fa-thermometer-3'>&#xf2c8; fa-thermometer-3</option>
                                                <option value='fa fa-thermometer-4'>&#xf2c7; fa-thermometer-4</option>
                                                <option value='fa fa-thermometer-empty'>&#xf2cb; fa-thermometer-empty</option>
                                                <option value='fa fa-thermometer-full'>&#xf2c7; fa-thermometer-full</option>
                                                <option value='fa fa-thermometer-half'>&#xf2c9; fa-thermometer-half</option>
                                                <option value='fa fa-thermometer-quarter'>&#xf2ca; fa-thermometer-quarter</option>
                                                <option value='fa fa-thermometer-three-quarters'>&#xf2c8; fa-thermometer-three-quarters</option>
                                                ...
                                                <option value='fa fa-times-rectangle'>&#xf2d3; fa-times-rectangle</option>
                                                <option value='fa fa-times-rectangle-o'>&#xf2d4; fa-times-rectangle-o</option>
                                                ...
                                                <option value='fa fa-universal-access'>&#xf29a; fa-universal-access</option>
                                                ...
                                                <option value='fa fa-usb'>&#xf287; fa-usb</option>
                                                ...
                                                <option value='fa fa-user-circle-o'>&#xf2be; fa-user-circle-o</option>
                                                <option value='fa fa-user-md'>&#xf0f0; fa-user-md</option>
                                                <option value='fa fa-user-o'>&#xf2c0; fa-user-o</option>
                                                ...
                                                <option value='fa fa-vcard-o'>&#xf2bc; fa-vcard-o</option>
                                                ...
                                                <option value='fa fa-viadeo'>&#xf2a9; fa-viadeo</option>
                                                <option value='fa fa-viadeo-square'>&#xf2aa; fa-viadeo-square</option>
                                                ...
                                                <option value='fa fa-volume-control-phone'>&#xf2a0; fa-volume-control-phone</option>
                                                ...
                                                <option value='fa fa-wheelchair-alt'>&#xf29b; fa-wheelchair-alt</option>
                                                <option value='fa fa-wifi'>&#xf1eb; fa-wifi</option>
                                                <option value='fa fa-wikipedia-w'>&#xf266; fa-wikipedia-w</option>
                                                <option value='fa fa-window-close'>&#xf2d3; fa-window-close</option>
                                                <option value='fa fa-window-close-o'>&#xf2d4; fa-window-close-o</option>
                                                ...
                                                <option value='fa fa-wpbeginner'>&#xf297; fa-wpbeginner</option>
                                                <option value='fa fa-wpexplorer'>&#xf2de; fa-wpexplorer</option>
                                                <option value='fa fa-wpforms'>&#xf298; fa-wpforms</option>
                                                ...
                                                <option value='fa fa-yoast'>&#xf2b1; fa-yoast</option>
