        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Update Invoice</h4>
                    <div class="text-end">
                    ...
                    <form action="">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <a href="#" class="btn btn-sm btn-danger">Download Invoice</a>
                                <a href="#" class="btn btn-sm btn-danger">Download Invoice Summary</a>
                            </div>
                        </div>
                    </form>
                </div>
