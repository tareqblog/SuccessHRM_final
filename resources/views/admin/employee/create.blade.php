                                    ...
                                    <div class="col-lg-4">
                                        <div class="mt-5 mt-lg-4 mt-xl-0">
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="user_right" class="form-control">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mt-5 mt-lg-4 mt-xl-0">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="address_3" rows="2" class="form-control"
                                                        placeholder="Address"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mt-5 mt-lg-4 mt-xl-0">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="date" name="pr_date" class="form-control" placeholder="PR Date">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mt-5 mt-lg-4 mt-xl-0">
                                            ...
                                            <div class="row mb-4">
                                                <label for="one" class="col-sm-3 col-form-label">Probation
                                                    Period</label>
                                                <div class="col-sm-9">
                                                    <select name="probation_period" class="form-control" id="">
                                                        <option value="">Select One</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="one" class="col-sm-3 col-form-label">Extention of
                                                    Probation</label>
                                                <div class="col-sm-9">
                                                    <select name="extention_of_probation" class="form-control" id="">
                                                        <option value="">Select One</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="date" name="resination_date" class="form-control"
                                            ...
                                            <div class="row mb-4">
                                                <label for="one" class="col-sm-3 col-form-label">Terminate
                                                    Reason</label>
                                                <div class="col-sm-9">
                                                    <textarea name="terminate_reason" rows="2" placeholder="Terminate Reason"
                                        ...
                                        <div class="mt-5 mt-lg-4 mt-xl-0">
                                            <div class="row mb-4">
                                                <label for="one" class="col-sm-3 col-form-label">Approved level
                                                    1</label>
                                                <div class="col-sm-9">
                                                    <select name="approved_level_1" class="form-control" id="">
                                                        <option value="">Select One</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="one" class="col-sm-3 col-form-label">Approved level
                                                    2</label>
                                                <div class="col-sm-9">
                                                    <select name="aprroved_level_2" class="form-control" id="">
                                                        <option value="">Select One</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="one" class="col-sm-3 col-form-label">Approved level
                                                    3</label>
                                                <div class="col-sm-9">
                                                    <select name="aprroved_level_3" class="form-control" id="">
                                                        <option value="">Select One</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mt-5 mt-lg-4 mt-xl-0">
                                            <div class="row mb-4">
                                                <label for="one" class="col-sm-3 col-form-label">Approved level
                                                    1</label>
                                                <div class="col-sm-9">
                                                    <select name="aprroved_level_1" class="form-control" id="">
                                                        <option value="">Select One</option>
                                                    </select>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane" id="leave" role="tabpanel">
                                ...
                                <div class="form-group mb-2">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="medical_reimbursement" value="0"
                                                placeholder="Days">
                                        </div>
                                        <div class="col-sm-3">
