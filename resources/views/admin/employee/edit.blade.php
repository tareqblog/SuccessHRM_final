                        ...
                        <div class="tab-content p-3 text-muted">
                                    ...
                                    <form action="">
                                        <div class="col-lg-6">
                                            <div class="mt-5 mt-lg-4 mt-xl-0">
                                                ...
                                                <div class="row mb-4">
                                                    <label for="one" class="col-sm-3 col-form-label">Hourly Salary
                                                        Rate</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="one" class="form-control"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mt-5 mt-lg-4 mt-xl-0">
                                                <div class="row mb-4">
                                                    <label for="one" class="col-sm-4 col-form-label">No of Work Days in
                                                        Month</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" name="one" class="form-control"
                                                ...
                                                <div class="row mb-4">
                                                    <label for="one" class="col-sm-4 col-form-label">Overtime Hourly
                                                        Rate</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" name="one" class="form-control"
                            ...
                            <div class="tab-pane" id="leave" role="tabpanel">
                                <div class="form-group mb-2">
                                    ...
                                    <label for="emplleave_leavetype" class="col-sm-3 control-label">Balance (2023)</label>
                                    <label for="emplleave_leavetype" class="col-sm-3 control-label">Entitled (2023)</label>
                                    <label for="emplleave_leavetype" class="col-sm-3 control-label">Balance (2022)</label>
                                </div>
                                <div class="form-group mb-2">
                                    <div class="row">
