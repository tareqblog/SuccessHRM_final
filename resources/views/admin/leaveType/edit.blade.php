    ...
    <form action="{{route('leave-type.update', $leave_type->id)}}" method="POST">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="row mb-4">
                    <label for="one" class="col-sm-3 col-form-label">Leave Type Code</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="leavetype_code" placeholder="Leave Type Code" value="{{$leave_type->leavetype_code}}">
                    </div>
                </div>
                <div class="row mb-4">
                    <label for="one" class="col-sm-3 col-form-label">Default Leave Days</label>
                    <div class="col-sm-9">
            ...
            <div class="col-lg-6">
                ...
                <div class="row mb-4">
                    <label for="one" class="col-sm-3 col-form-label">Block Candidate</label>
                    <div class="col-sm-9">
