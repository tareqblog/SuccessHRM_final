                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="remark" rows="2" class="form-control" placeholder="Internal Remark"> {{ $job->remark }} </textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="short_desc" rows="2" class="form-control" placeholder="Short Description"> {{ $job->short_desc }} </textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                ...
                                <div class="col-lg-12">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="description" id="ckeditor-classic" rows="2"> {{ $job->description }} </textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
