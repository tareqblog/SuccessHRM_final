                                        ...
                                        <div class="mt-5 mt-lg-4 mt-xl-0">
                                            ...
                                            <div class="row mb-1 ">
                                                <label for="four" class="col-sm-3 col-form-label">Remarks<span
                                                        class="text-danger">*</span></label>
                                                <div class="col-sm-9">
                                                    <textarea name="candidate_emr_remarks" id="candidate_emr_remarks" rows="2" class="form-control"
                                                        placeholder="Remarks" required> {{ $candidate->candidate_emr_remarks }} </textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card-header">
                                            <div class="d-flex bd-highlight">
                                                ...
                                                <div class="p-2 bd-highlight">
                                                    <a data-bs-toggle="modal"
                                                        data-bs-target=".bs-example-modal-lg-create"
                            ...
                            @if (App\Helpers\FileHelper::usr()->can('candidate.remark'))
                                <form action="{{ route('candidate.remark', $candidate->id) }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-6 mb-1">
                                            ...
                                            <div class="row">
                                                <label for="one" class="col-sm-3 col-form-label fw-bold">Remark
                                                    Type</label>
                                                <div class="col-sm-9">
                                                    <select name="remarkstype_id"
                                                        class="form-control single-select-field"
                                                        id="remark_type_test">
                                                        <option value="" selected disabled>Select One</option>
                                                        @if ($auth->roles_id == 1)
                                                            <option value="1"
                                                                {{ old('remarkstype_id') == 1 ? 'selected' : '' }}>
                                                                Assign To Manager</option>
                                                        @endif
                                                        @if ($auth->roles_id == 8)
                                                            <option value="11"
                                                                {{ old('remarkstype_id') == 11 ? 'selected' : '' }}>
                                                                Assign To Own</option>
                                                        @endif
                                                        @if ($auth->roles_id == 4 || $auth->roles_id == 11)
                                                            <option value="3"
                                                                {{ old('remarkstype_id') == 3 ? 'selected' : '' }}>
                                                                Assign To RC</option>
                                                        @endif
                                                        @if ($auth->roles_id == 4)
                                                            <option value="2"
                                                                {{ old('remarkstype_id') == 2 ? 'selected' : '' }}>
                                                                Assign To Team Leader</option>
                                                        @endif
                                                        @if ($auth->roles_id == 8 || $auth->roles_id == 11 || $auth->roles_id == 4)
                                                            <option value="9"
                                                                {{ old('remarkstype_id') == 9 ? 'selected' : '' }}>
                                                                Reassign</option>
                                                        @endif
                                                        @if ($auth->roles_id == 1 || $auth->roles_id == 4)
                                                            <option value="12"
                                                                {{ old('remarkstype_id') == 12 ? 'selected' : '' }}>
                                                                Share to Other Managers (Admin / Manager use only)
                                                            </option>
                                                        @endif
                                                        <option value="4"
                                                            {{ old('remarkstype_id') == 4 ? 'selected' : '' }}>
                                                            Candidate Follow Up</option>
                                                        <option value="5"
                                                            {{ old('remarkstype_id') == 5 ? 'selected' : '' }}>Assign
                                                            Interview</option>
                                                        <option value="6"
                                                            {{ old('remarkstype_id') == 6 ? 'selected' : '' }}>Assign
                                                            To Client</option>
                                                        <option value="7"
                                                            {{ old('remarkstype_id') == 7 ? 'selected' : '' }}>
                                                            Shortlisted</option>
                                                        <option value="22"
                                                            {{ old('remarkstype_id') == 22 ? 'selected' : '' }}>Call
                                                            Back</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-6 mb-1" id="AssignToClient"
                                            style="display: none;">
                                            <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-6 mb-1" id="interviewTime"
                                            style="display: none;">
                                            <div class="row">
                                                <label for="one"
                                                    class="col-sm-3 col-form-label fw-bold">Interview Time</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="col-md-6 col-lg-6 mb-1" id="interviewCompany"
                                            ...
                                            <div class="row">
                                                <label for="one"
                                                    class="col-sm-3 col-form-label fw-bold">Interview Company <span
                                                        class="text-danger">*</span></label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="col-md-6 col-lg-6 mb-1" id="expectedSalary"
                                            ...
                                            <div class="row">
                                                <label for="one"
                                                    class="col-sm-3 col-form-label fw-bold">Expected Salary</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control"
                                        ...
                                        <div class="col-md-6 col-lg-6 mb-1" id="interviewPosition"
                                            ...
                                            <div class="row">
                                                <label for="one"
                                                    class="col-sm-3 col-form-label fw-bold">Interview Position <span
                                                        class="text-danger">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control"
                                        ...
                                        <div class="col-md-6 col-lg-6 mb-1" id="receivedJobOffer"
                                            ...
                                            <div class="row">
                                                <label for="one"
                                                    class="col-sm-3 col-form-label fw-bold">Received Job Offer</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="col-md-6 col-lg-6 mb-1" id="shortlistClientCompany"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="client_company" id="short_client_company"
                                                        class="form-control single-select-field" required>
                                                        <option value="">Select One</option>
                                                        @foreach ($clients as $client)
                                                            <option value="{{ $client->id }}">
                                                                {{ $client->client_name }}</option>
                                                    ...
                                                    <div id="client_company_error" style="display: none; color: red;">Please select a client company.</div>
                                        ...
                                        <div class="col-md-6 col-lg-6 mb-1" id="shortlistPlacement"
                                            ...
                                            <div class="row">
                                                <label for="one"
                                                    class="col-sm-3 col-form-label fw-bold">Placement / Recruitment
                                                    Fee </label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control"
                                        ...
                                        <div class="col-md-6 col-lg-6 mb-1" id="shortlistJobTitle"
                                            style="display: none;">
                                            <div class="row">
                                                <label for="one" class="col-sm-3 col-form-label fw-bold">Job
                                                    Title <span class="text-danger">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="shortlist_job_title"
                                        ...
                                        <div class="col-md-6 col-lg-6 mb-1" id="shortlistProbationPeriod"
                                            ...
                                            <div class="row">
                                                <label for="one"
                                                    class="col-sm-3 col-form-label fw-bold">Probation Period</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="col-md-6 col-lg-6 mb-1" id="shortlistContractSigningDate"
                                            ...
                                            <div class="row">
                                                <label for="one"
                                                    class="col-sm-3 col-form-label fw-bold">Contract Signing Date
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="isNotice" class="form-control single-select-field"
                                                        ...
                                                        <option value="" selected disabled>Select One</option>
                                                        <option value="1"
                                                            {{ old('isNotice') == 1 ? 'selected' : '' }}>Yes</option>
                                                        <option value="0"
                                                            {{ old('isNotice') == 0 ? 'selected' : '' }}>No</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-6 mb-1" id="AssignToManager"
                                            style="display: none;">
                                            <div class="row">
                                                <label for="one" class="col-sm-3 col-form-label fw-bold">Assign
                                                    To
                                                    <span class="text-danger">*</span> </label>
                                                <div class="col-sm-9">
                                                    <select name="Assign_to_manager"
                                                        ...
                                                        @foreach ($users as $user)
                                                            <option value="{{ $user->id }}"
                                                                {{ old('Assign_to_manager') == $user->id || $candidate->Assign_to_manager == $user->id ? 'selected' : '' }}>
                                                                {{ $user->employee_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="col-md-6 col-lg-6 mb-1" id="reassign" style="display: none;">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="Assign_to_manager" id="Assign_to_manager"
                                                        class="form-control single-select-field">
                                                        <option value="" selected disabled>Select One</option>
                                        ...
                                        <div class="col-12 mb-1">
                                            <div class="row">
                                                <label for="remarks" class="col-sm-12 col-md-1 col-form-label fw-bold">Remark <span class="text-danger">*</span></label>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        {{-- <div class="col-lg-12 mt-5 mt-lg-4 mt-xl-0 row">
                                            ...
                                            <div class="row mb-1 col-lg-6" id="closeRate1">
                                                <label for="one" class="col-sm-3 col-form-label">Closed Rate 1</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="row mb-1 col-lg-6" id="closeRate2">
                                                <label for="one" class="col-sm-3 col-form-label">Closed Rate 2</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="row mb-1 col-lg-6" id="closeRate3">
                                                <label for="one" class="col-sm-3 col-form-label">Closed Rate 3</label>
                                                <div class="col-sm-9">
                                                    <input type="number" name="close_rate3" class="form-control" placeholder="Closed Rate 3">
                                                </div>
                                            </div>
                                            ...
                                            @foreach ($payrolls as $payroll)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form action="{{ route('candidate.payroll.delete', $payroll->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button class="btn btn-danger btn-sm"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mt-5 mt-lg-4 mt-xl-0">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="schedul_day" id="" class="form-control single-select-field">
                                                        <option value="">Select One</option>
                                                        @for ($i = 0; $i < 32; $i++)
                                                        <option value="{{ $i }}"
                                ...
                                enctype="multipart/form-data">
                                    ...
                                    <div class="mt-5 mt-lg-4 mt-xl-0">
                                        <div class="row mb-1">
                                            ...
                                            Name</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="resume_name" id="resume_name" class="form-control" value="{{ old('resume_name') }}">
                                            </div>
                                        </div>
                                        <div class="row mb-1">
...
@section('scripts')
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            let randomName = 'Resume_' + Math.random().toString(36).substring(2, 15);
            document.getElementById('resume_name').value = randomName;
            ...
            $('body').on('change', '#remark_type_test', function() {
                ...
                if (selectedValue === '9') {
                    $('#reassign').show();
                    $('#Assign_to_manager').show().prop('required', true);
                } else {
                    $('#reassign').hide();
                    $('#Assign_to_manager').show().prop('required', false);
                }
                ...
                if (selectedValue === '7') {
                    $('#short_client_company').prop('required', true);
                    ...
                    $('#short_client_company').prop('required', false);
