                            ...
                            @if (isset($name))
                                ...
                                <div class="card">
                                    <form>
                                        ...
                                        <input class="form-control" type="text" name="email" value="{{ $name }}">
                                        <input class="form-control" type="text" name="name" value="{{ $email }}">
                                        <input class="form-control" type="text" name="phone" value="{{ $phone_no }}">
