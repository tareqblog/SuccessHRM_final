                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-6 mb-1" id="shortlistClientCompany" style="display: none;">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="client_company" class="form-control single-select-field">
                                                    <option value="" selected disabled>Select One</option>
                                                    @foreach ($clients as $client)
                                    ...
                                    <div class="col-md-6 col-lg-6 mb-1" id="interviewEmailNoticeDate"
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control"
                                                name="interviewEmailNoticeDate" value="{{ old('interviewEmailNoticeDate', $remark->interview?->interview_date)}}">
                                        </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 mb-1">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="isNotice" class="form-control single-select-field" required disabled>
                                                <option value="" selected disabled>Select One</option>
                                                <option value="1" {{ old('isNotice', $remark->isNotice) == 1 ? 'selected' : '' }}>Yes</option>
                                                <option value="0" {{ old('isNotice', $remark->isNotice) == 0 ? 'selected' : '' }}>No</option>
                                            </select>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-6 mb-1" id="shortlistReminderPeriod" style="display: none;">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="shortlistReminderPeriod"
                                                ...
                                                <option value="2 Week Before" {{ $remark->shortlist?->reminder_period == '2 Week Before' ? 'selected' : ''}}>2 Week Before</option>
                                                <option value="3 Week Before" {{ $remark->shortlist?->reminder_period == '3 Week Before' ? 'selected' : ''}}>3 Week Before</option>
                                                <option value="4 Week Before" {{ $remark->shortlist?->reminder_period == '4 Week Before' ? 'selected' : ''}}>4 Week Before</option>
                                                <option value="5 Week Before" {{ $remark->shortlist?->reminder_period == '5 Week Before' ? 'selected' : ''}}>5 Week Before</option>
                                                <option value="6 Week Before" {{ $remark->shortlist?->reminder_period == '6 Week Before' ? 'selected' : ''}}>6 Week Before</option>
                                                <option value="7 Week Before" {{ $remark->shortlist?->reminder_period == '7 Week Before' ? 'selected' : ''}}>7 Week Before</option>
                                                <option value="8 Week Before" {{ $remark->shortlist?->reminder_period == '8 Week Before' ? 'selected' : ''}}>8 Week Before</option>
                                            </select>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-6 mb-1" id="AssignToRC" style="display: none;">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="rc" class="form-control single-select-field">
                                                <option value="">Select One</option>
                                                @foreach ($users as $user)
                                                    <option value="{{ $user->id }}" {{ $remark->assign_rc?->rc_id == $user->id ? 'selected' : ''}}>
                                                        {{ $user->employee_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6 col-lg-6 mb-1" id="attendInterview" style="display: none;">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="attendInterview"
                                                ...
                                                <option value="yes" {{ old('attendInterview', $remark->interview?->attend_interview) == '1' ? 'selected' : '' }}>Yes</option>
                                                <option value="no" {{ old('attendInterview', $remark->interview?->attend_interview) == '0' ? 'selected' : '' }}>No</option>
                                            </select>
                                        </div>
                                        </div>
                                    </div>
    ...
    @section('scripts')
        ...
        <script language="javascript" type="text/javascript">
            ...
            window.addEventListener('DOMContentLoaded', (event) => {
                // Find and click on the element corresponding to the "Remark" tab
                let remarkTab = document.querySelector('#remark-tab');
                if (remarkTab) {
                    remarkTab.click(); // Simulate a click event to open the tab
                }
            });
        </script>
        <script>
