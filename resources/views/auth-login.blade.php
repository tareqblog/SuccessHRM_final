                                    ...
                                    <div class="p-2 mt-4">
                                        <form method="POST" action="{{ route('login') }}" class="auth-input">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @enderror
                                                <p class="text-center font-size-12">Please enter the  <strong>OTP</strong> generated on your Authenticator App. Ensure you submit the current one because it refreshes every 30 seconds.</p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <p>©
                                    ...
                                    </script> Success HR, Design & Developed By <a class="text-dark" href="https://digipixel.sg" traget="_blank">Digipixel</a>
                                </p>
                            </div>
                        </div>
                    </div>
